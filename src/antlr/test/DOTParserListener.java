...
public interface DOTParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DOTParser#node_name}.
	 * @param ctx the parse tree
	 */
	void enterNode_name(DOTParser.Node_nameContext ctx);
	/**
	 * Exit a parse tree produced by {@link DOTParser#node_name}.
	 * @param ctx the parse tree
	 */
	void exitNode_name(DOTParser.Node_nameContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link DOTParser#name}.
	 * @param ctx the parse tree
	 */
	void enterName(DOTParser.NameContext ctx);
	/**
	 * Exit a parse tree produced by {@link DOTParser#name}.
	 * @param ctx the parse tree
	 */
	void exitName(DOTParser.NameContext ctx);
}